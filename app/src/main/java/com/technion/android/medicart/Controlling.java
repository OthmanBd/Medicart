...
public class Controlling extends Activity {
    ...
    private String pill1,pill2,pill3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm = findViewById(R.id.confirm_treatment);
        ...
        pill1 = getIntent().getStringExtra("Pill 1");
        pill2 = getIntent().getStringExtra("Pill 2");
        pill3 = getIntent().getStringExtra("Pill 3");
        ...
        confirm.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                try {
                    mBTSocket.getOutputStream().write(pill1.getBytes());
                } catch (IOException e) {
                    e.printStackTrace();
                }
                try {
                    mBTSocket.getOutputStream().write(pill2.getBytes());
                } catch (IOException e) {
                    e.printStackTrace();
                }
                try {
                    mBTSocket.getOutputStream().write(pill3.getBytes());
                } catch (IOException e) {
                    e.printStackTrace();
                }
                saveTreatmentLog();
